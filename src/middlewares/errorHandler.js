...
const { safeStringify, logger } = require("../common/utils/logger");


// Kung wala ang TransactionError, gumawa tayo ng fallback
/**
 * @type {typeof import("../common/utils/dbUtils/transactionWrapper").TransactionError}
 */
let TransactionError;
try {
  TransactionError = require("../common/utils/dbUtils/transactionWrapper").TransactionError;
} catch (err) {
